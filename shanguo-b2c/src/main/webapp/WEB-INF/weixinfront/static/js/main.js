...
function know_confirm(param) {
    ...
    var tpl='<div id="confirm" class="dialog-con">'
        ...
        +'</p>'
        +'<div class="clearfix">'
        +'<div id="okBtn" class="fl w100 btn-active" style="padding: 0.5rem 0;">'+param.btnOk+'</div>'
        +'</div>'
        +'</div>'
        +'</div>'
        +'</div>';
...
Util.weixinMenu = {
    shareIndex:function(){
        ...
        var shareUrl = 'weixinfront/static/goods_detail.html?share=0&'+'storeId='+sessionStorage.getItem('shopId')+'&id='+ Util.common.getParameter("id")+ '&type=weixinIndex&flag=T';
        ...
        Util.common.executeAjaxCallback(vurl , param , function(data){
            ...
            wx.ready(function(){
                ...
                if(storeInfo.isActive==true ||storeInfo.isActive=='true'){
                    var shareUrl = 'weixinfront/static/goods_detail.html?activity=true&'+'storeId='+sessionStorage.getItem('shopId')+'&id='+ Util.common.getParameter("id")+ '&type=weixinIndex&flag=T';
                }else {
                    var shareUrl = 'weixinfront/static/goods_detail.html?share=0&'+'storeId='+sessionStorage.getItem('shopId')+'&id='+ Util.common.getParameter("id")+ '&type=weixinIndex&flag=T';
                }
                var shareTitle =storeInfo.name;
                var shareDesc =storeInfo.name+'据说，这款宝贝上全城热搜榜了？';
