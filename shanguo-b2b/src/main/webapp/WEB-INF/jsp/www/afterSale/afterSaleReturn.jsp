        ...
        <div class="step-form">
            <div class="left-title clearfix">
                ...
                <div class="server-select pull-left">
                    <span class="server-title">
                        <input class="server-input" type="text" readonly value="退款退货" name="afterService" data-service="refund_return" id="serverInput">
                    </span>
            ...
            <div class="form-group clearfix">
                ...
                <div class="reason-wrap pull-left">
                    ...
                    <c:if test="${empty orderItemAsFlow && empty orderItemAsFlow.returnReason}">
                        <input type="text" name="returnSeason" value="请选择退款退货原因" readonly id="reasonInput">
                        <ul class="reason-list">
                            <c:forEach items="${returnReasonList}" var="returnReason">
                                <li>${returnReason.value}</li>
                            </c:forEach>
            ...
            <div class="form-group clearfix">
                ...
                <div class="exchange pull-left clearfix">
                    <c:if test="${!empty orderItemAsFlow && !empty orderItemAsFlow.returnAmount}">
                        <input type="text" name="returnAmount" value="${orderItemAsFlow.returnAmount}" data-max-price="${goodMsgList.refundAmount}">
                    </c:if>
                    <c:if test="${empty orderItemAsFlow.returnAmount}">
                        <input type="text" name="returnAmount" value="${goodMsgList.refundAmount}" data-max-price="${goodMsgList.refundAmount}">
                    </c:if>
                    <%--<c:if test="${empty orderItemAsFlow && empty orderItemAsFlow.returnAmount}">--%>
                        <%--<input type="text" name="returnAmount" value="${goodMsgList.returnAmount}" data-max-price="${goodMsgList.returnAmount}">--%>
                    <%--</c:if>--%>
