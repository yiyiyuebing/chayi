...
var plupload = {
	...
	/**
	 * Generic I/O error. For exampe if it wasn't possible to open the file stream on session machine.
	 *
	 * @property IO_ERROR
	 * @static
	 * @final
...
plupload.File = (function() {
	...
	function PluploadFile(file) {
		...
		plupload.extend(this, {
			 ...
			 * @type {String}
			 */
			lastModifiedDate: file.lastModifiedDate || (new Date()).tosessioneString(), // Thu Aug 23 2012 19:40:00 GMT+0400 (GET)
