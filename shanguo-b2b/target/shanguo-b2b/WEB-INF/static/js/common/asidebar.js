                ...
                if ($("input[name=shopId]").val().length > 0) {
                    ...
                    if ($("input[name=product-id]").length > 0) {
                        ysf.product({
                            ...
                            title : $("input[name=product-name]").val() ? $("input[name=product-name]").val() + '（PC商城）' : '',
                            desc : $("input[name=product-desc]").val() ? $("input[name=product-desc]").val() : "",
                            picture : $("input[name=product-img]").val() ? $("input[name=product-img]").val() : "",
                            note : $("input[name=product-price]").val() ? $("input[name=product-price]").val() : "",
