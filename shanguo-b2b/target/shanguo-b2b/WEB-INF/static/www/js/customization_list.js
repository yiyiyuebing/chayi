...
var  ProductList = {
    ...
    moreFunction:function(){
        ...
        for(var i = 0 ;i < $(".classic-select-radio").length;i++){
            $(".classic-select-radio").eq(i).height($(".classic-select-radio").eq(i).find("li").height());
        };
        ...
        $(".more").click(function(){
            ...
            if(parseInt( oLi.height() ) == parseInt(oUl.height()) ){
                oUl.height(n*oLi.height());
                $(this).html("<i class='up'></i>收起");
            }else{
                oUl.height(oLi.height());
                $(this).html("<i></i>更多");
            }
        });
    },
    ...
    imgSelectFunction:function(){
        ...
        $(".classic-select-checkbox-imgBox").find("li").click(function(){
            if($(this).find(".mask-img").hasClass("active")){

                $(this).find(".mask-img").removeClass("active");
                ...
                /*重置HTML*/
                html = '<li class="pull-left">已经选条件：</li>';
                $(this).find(".mask-img").addClass("active");
                /*获取关联name数据*/
