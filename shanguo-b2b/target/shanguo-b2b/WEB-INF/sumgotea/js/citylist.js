...
(function () {
    var cityList = {
        ...
        insertHtml: function () {
            var search_str = '<header id="search_wrap"><div  class="fl location "><span id="citySearch"></span><i class="selected_city"></i></div>';
            search_str += '<p class="fl"><input class="search-icon" id="txt_city" maxlength="10" placeholder="城市/行政区" type="text" /></p>';
            ...
            if (city_str)
                city_str = '<main id="city_wrap" class="page"><div id="topView">当前城市: <span id="locCity"></span> <div class="btn-active">重新定位</div> </div>' 
                + city_str + letter_str + '</main>';
