...
<body>
  ...
  <div id="orderInfo">
    <c:forEach items="${orderInfo.orderListVos}" var="goodSku">
      <input type="hidden" name="skuInfo" data-sku-id="${goodSku.purGoodsSkuId}" data-number="${goodSku.number}" data-isSample="${goodSku.isSample}" data-goods-id="${goodSku.purGoodsId}"/>
    </c:forEach>
  </div>
  <!--主体-->
  ...
  <div class="order-body">
    ...
    <div class="order-body-content">
      <input type="hidden" name="orderType" value="${orderInfo.typeName}"/>
    ...
    <div class="order-body-content">
      ...
      <div class="customer-message clearfix">
        ...
        <div class="customer-message-group pull-left clearfix">
          ...
          <span class="pull-left post-service">普通配送 快递 免邮</span>
        </div>
        <div class="customer-message-group pull-left clearfix" style="margin-right: 0">
          <label class="pull-left">费用合计（含运费）</label>
          <span class="pull-left color-red order-total-price">¥0.00</span>
        </div>
      </div>
    </div>
    <div class="order-body-content">
          ...
          <div class="address-input-group">
            ...
            <div class="address-location">
              <div class="express-wrap">
                ...
                <input type="hidden" name="provinceName"  id="add-provinceName" data-rule="required" data-validate-info="省市区不能为空"/>
                <input type="hidden" name="cityName" id="add-cityName" data-rule="required" data-validate-info="省市区不能为空"/>
                <input type="hidden" name="areaName" id="add-areaName" data-rule="required" data-validate-info="省市区不能为空"/>
          ...
          <div class="address-input-group">
            ...
            <div class="address-location">
              <div class="express-wrap">
                ...
                <input type="hidden" name="provinceName"  id="edit-provinceName" data-rule="required" data-validate-info="省市区不能为空"/>
                <input type="hidden" name="cityName" id="edit-cityName" data-rule="required" data-validate-info="省市区不能为空"/>
                <input type="hidden" name="areaName" id="edit-areaName" data-rule="required" data-validate-info="省市区不能为空"/>
...
<script id="tpl-product-info" type="text/html">
  <li class="clearfix good-sku-item">
    ...
    <div class="product-count pull-left clearfix">
      {{if isSancha == 'T' && supplyPriceList}}
        {{each supplyPriceList as supplyPriceItem index}}
        ...
        {{/each}}
      {{/if}}
      <a href="javascript:void(0)" class="subtraction pull-left disabled" data-start-num="{{startNum}}" data-mul-num-flag="{{mulNumFlag}}">-</a>
      <input class="pull-left ipt-sku-num" type="text" value="{{number}}" readonly data-sku-id="{{skuId}}" data-is-sample="{{isSample}}" data-price="{{price}}" name="number" data-start-num="{{startNum}}" data-mul-num-flag="{{mulNumFlag}}" data-sancha-flag="{{isSancha}}" data-onsaleno="{{onSalesNo}}">
      <a href="javascript:void(0)" class="plus pull-left" data-start-num="{{startNum}}" data-mul-num-flag="{{mulNumFlag}}" data-onsaleno="{{onSalesNo}}">+</a>
    </div>
    ...
    <%--{{if giftRuleList && giftRuleList.length > 0}}--%>
      <%--<div class="clearfix"></div>--%>
      <%--<div class="gift">--%>
        <%--<table>--%>
          <%--<tbody>--%>
          <%--{{each giftRuleList as giftRule index}}--%>
            <%--<tr>--%>
              <%--<td style="display: none">--%>
                <%--<input type="hidden" name="condType" value="{{giftRule.condType}}">--%>
                <%--<input type="hidden" name="condNum" value="{{giftRule.condNum}}">--%>
                <%--<input type="hidden" name="initNum" value="{{giftRule.num}}">--%>
              <%--</td>--%>
              <%--<td>【赠品】{{giftRule.giftName}}</td>--%>
              <%--<td> x<span class="gift-num">{{giftRule.num}}</span></td>--%>
              <%--<td>&lt;%&ndash;<a href="#">查看价格</a>&ndash;%&gt;</td>--%>
            <%--</tr>--%>
          <%--{{/each}}--%>
          <%--</tbody>--%>
        <%--</table>--%>
