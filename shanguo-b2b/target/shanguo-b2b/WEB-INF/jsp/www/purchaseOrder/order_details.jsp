    ...
    <div class="state-lcol">
        ...
        <c:if test="${pov.status == 20}">
            <span class="remain-time">
                <strong class="time-icon">尾款支付期：<fmt:formatDate value="${pov.paymentList[1].payStart}" pattern="yyyy-MM-dd"/> -<fmt:formatDate value="${pov.paymentList[1].payEnd}" pattern="yyyy-MM-dd"/></strong>
            </span>
            <div class="state-btns">
        ...
        <div class="dl">
            ...
            <div class="dd">
                ...
                <div class="item clearfix">
                    ...
                    <div class="info-rcol">${pov.address}</div>
                </div>
                <div class="item clearfix">
                ...
                <c:forEach items="${pov.orderListVos}" var="good">
                    <c:if test="${good.giftFlag != 'T'}">
                        <tr>
                            ...
                            <td>
                                <c:if test="${good.giftFlag != 'T' && pov.isSample != 'T'}">
                                    <c:if test="${pov.status == 2}">
