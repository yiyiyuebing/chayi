        ...
        <div class="order-state">
            <div class="state-cont">
                <div class="state-lcol">
                    ...
                    <h3 class="state-txt red">等待收货</h3>
                ...
                <div class="state-rcol">
                    <div class="state-rtop cl9">该订单会为您保留24.0小时（从下单之日算起），24.0小时之后如果还未付款，系统将自动取消该订单。</div>
