...
<div class="step-nav clearfix">
  ...
  <i class="step-break step-break-transition pull-left"></i>
        <span class="step step-success pull-left">
            <i class="icon-success"></i>卖家处理换货申请
        </span>
    ...
    <div class="change-success">
      ...
      <div class="step-waiting">
        ...
        <div class="waiting-operation clearfix">
          ...
          <a href="javascript:void(0);" id="seeChangeInfoBtn" data-type="freight-info" data-freight-no="${orderItemAsFlow.kefuFreightNo}" class="change-server again-apply-after-sale pull-left">查看物流信息</a>
        </div>
      </div>
    ...
    <div class="popup">
      ...
      <div class="popup-body">
        <div class="info-header">
          <label>发货物流公司：</label>
          <span>${orderItemAsFlow.kefuFreightCompany}</span>
          <label>运单号：</label>
          <span>${orderItemAsFlow.kefuFreightNo}</span>
        </div>
        <div class="info-wrap">
          <ul class="info-body">
