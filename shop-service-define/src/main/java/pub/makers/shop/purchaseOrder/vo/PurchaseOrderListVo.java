...
public class PurchaseOrderListVo extends BaseOrderItem {
    ...
    private PurchaseGoodsEvaluationVo evaluationVo;
    ...
    public PurchaseGoodsEvaluationVo getEvaluationVo() {
        return evaluationVo;
    }

    public void setEvaluationVo(PurchaseGoodsEvaluationVo evaluationVo) {
