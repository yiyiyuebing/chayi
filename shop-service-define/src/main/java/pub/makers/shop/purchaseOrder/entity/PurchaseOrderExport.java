...
public class PurchaseOrderExport implements Serializable {
    ...
    private List<PurchaseOrderListExport> orderListExportList;
    ...
    public List<PurchaseOrderListExport> getOrderListExportList() {
        return orderListExportList;
    }

    public void setOrderListExportList(List<PurchaseOrderListExport> orderListExportList) {
        this.orderListExportList = orderListExportList;
    }
