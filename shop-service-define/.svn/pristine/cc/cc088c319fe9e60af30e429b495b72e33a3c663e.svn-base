 ...
 */
public class IndentExport implements Serializable {

    private String name; //订单号
    private String receiver; //收货人
    private String receiverPhone; //收货人手机号
    private String address; //收货地址
    private String invoiceContent; //发票
    private String invoiceName; //抬头
    private String invoiceDutyParagraph; //发票税号
    private String buyerCarriage; //运费
    private String paymentAmount; //实际支付金额（含运费）
    ...
    private List<IndentListExport> indentListExports;
    ...
    public String getIsSubAccount() {
        if (StringUtils.isNotBlank(this.isSubAccount) &&  "T".equals(this.isSubAccount)) {
            return "子账号";
        }
        return "微信";
    }
    ...
    public List<IndentListExport> getIndentListExports() {
        return indentListExports;
    }

    public void setIndentListExports(List<IndentListExport> indentListExports) {
        this.indentListExports = indentListExports;
    }
