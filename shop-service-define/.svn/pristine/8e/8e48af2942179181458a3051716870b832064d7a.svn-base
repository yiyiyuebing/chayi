 ...
 */
public class GoodEvaluationManageVo implements Serializable{
    ...
    private List<GoodEvaluationManageVo> replyEvaluationList;    //回复内容
    ...
    public List<GoodEvaluationManageVo> getReplyEvaluationList() {
        return replyEvaluationList;
    }

    public void setReplyEvaluationList(List<GoodEvaluationManageVo> replyEvaluationList) {
